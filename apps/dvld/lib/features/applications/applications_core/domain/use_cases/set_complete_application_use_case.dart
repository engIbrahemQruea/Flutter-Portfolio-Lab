...
class SetCompleteApplicationUseCase extends BaseUseCase<bool, int> {
  SetCompleteApplicationUseCase(this._applicationsRepository);
  ...
  Future<Either<Failure, bool>> call([int? applicationId]) async {
    return _applicationsRepository.updateApplicationStatus(
      ...
      newStatus: ApplicationStatus.completed.value,
    );
  }
}
