...
class GetPeopleByFirstNameUseCase extends BaseUseCase<List<PeopleEntity?>, String> {
  final PeopleRepos _repos;

  GetPeopleByFirstNameUseCase(this._repos);

  @override
  Future<Either<Failure, List<PeopleEntity?>>> call([String? params]) async {
    return await _repos.getPeopleByFirstName(firstName: params!);
  }
}
